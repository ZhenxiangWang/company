...
export default function Page2({ isMobile }) {
  const componentButton = (
    <div key="b" className="components-button-wrapper">
      <a>
        Ant Design of React <RightOutlined />
      </a>
      <a>
        Ant Design of Angular <RightOutlined />
      </a>
      <a>
        Ant Design of Vue <RightOutlined />
      </a>
    </div>
  );
      ...
      <div className="page">
        ...
        >
          ...
          >
            ...
            <p key="p">
              基于 Ant Design 设计语言，我们提供了一套开箱即用的高质量 React
              组件，用于开发和服务于企业级中后台产品，除官方的 React 实现，还有
              Angular、Vue 的实现
            </p>
            {componentButton}
          </QueueAnim>
